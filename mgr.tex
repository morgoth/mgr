...
dwóch obiektów sprowadza się do jednej linijki kodu w ciele klasy:
\begin{listing}
...
pamiętać o umieszczeniu kolumny \emph{student\_id} w tabeli \emph{exams}. Jak
...
nie powoduje ,,potworków językowych'', takich jak \emph{student has many
egzamins}.
