...
\begin{itemize}
  ...
  \item{Odpowiednie Gemy (m.in. Ruby on Rails)}
  \item{Biblioteka rmagic do obróbki ilustracji}
\end{itemize}


Sam system \emph{Ubuntu} możemy pobrać ze strony internetowej \cite{ubuntu}.
Następnie instalujemy \emph{Ruby} w wersji 1.8, najprościej z linii poleceń wydać komendy,
tak jak na listingu nr~\ref{listing:ubuntu_ruby}.

\begin{listing}
  \input{listing/ubuntu_ruby}
  \caption{Instalacja Ruby}
  \label{listing:ubuntu_ruby}
\end{listing}


Kolejną rzeczą jest system paczek \emph{Rubiego} zwany \emph{RubyGems}.
