...
Jeśli wartością pola \texttt{value} jest ,,true'', oznacza to że została ona zaznaczona przez studenta, w
takim przypadku przepisujemy wartość punktową zdefiniowaną przez nauczyciela, w przeciwnym
razie wpisujemy 0. Jeśli pytanie było typu porównania do wzorca, za pomocą odległości
