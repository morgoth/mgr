...
listing \ref{listing:selfcommenting}.
\begin{listing}
...
Przykład przedstawiony na listingu \ref{listing:activerecord_finders}.
\begin{listing}
...
listingu \ref{listing:activerecord_association}.
\begin{listing}
...
metody jak przedstawione na listingu \ref{listing:activerecord_association_finders}.
\begin{listing}
...
własne. Przykładowy sposób użycia przedstawia listing \ref{listing:activerecord_validations}.
\begin{listing}
...
usuwaniu powiązanych obiektów. Przykładowe \texttt{callbacki} na listingu \ref
{listing:activerecord_callbacks}.
\begin{listing}
...
wygenerowany plik na listingu \ref{listing:activerecord_migrations}.
\begin{listing}
...
\emph{ActiveResource} jest biblioteką umożliwiającym komunikację z innymi
...
wykorzystania przedstawione na listingu \ref{listing:activesupport}.
\begin{listing}
...
sprowadza się do umieszczenia w kontrolerze głównym linijki: \texttt
...
architektury oprogramowania, który próbuje przestawić reprezentację zasobów oraz
...
obiektach połączonych z bazą danych. Zestawienie oraz koneksję przestawia tabela
\ref{table:rest}.
\begin{table}[htc]
...
domnkąć tag, to dokument i tak będzie wyświetlony w przeglądarce, błędy nie zwracają
wyjątku.\\
