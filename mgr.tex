...
zawierają skrypty \emph{JavaScriptowe}. Służą one do obsługi interfejsu użytkownika i
przy wyłączonym interpreterze w przeglądarce, praktycznie żadna funkcjonalność nie działa.
