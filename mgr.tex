...
\begin{titlepage}
  \begin{center}
    ...
    internetowych do zdalnej edukacji w oparciu o technologię\\[0.5em]
    Ruby on Rails\\[80pt]
  \end{center}
...
\section{Windows}
Ze strony pobieramy instalator \emph{Rubiego}, uruchamiamy i podążamy krokami wyznaczonymi
przez przyjazny kreator. Po drodze zaznaczamy opcję ,,enable rubygems''. Po instalacji
(domyślnie do folderu C:/ruby), sprawdzamy czy pliki wykonywalne są widoczne ze
zmiennej środowiskowej \texttt{PATH}, wydając komendę z linii poleceń \texttt{ruby -v},
...
przebiegło pomyślnie, aktualizujemy pakiet poprzez \texttt{gem update --system}. Następnie
możemy zainstalować program obsługujący \emph{Gita} i pobrać aktualną wersję aplikacji
poprzez polecenie \texttt{git clone git://github.com/morgoth/quiz.git}.

rubyinstaller, zaznaczyć opcję enable rubygems, update rubygems, dll i exe dla sqlite
